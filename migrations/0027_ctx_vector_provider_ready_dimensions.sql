...
DROP INDEX IF EXISTS ctx_memory_vectors_embedding_idx;
DROP INDEX IF EXISTS ctx_memory_vectors_embedding_hnsw_idx;

TRUNCATE TABLE ctx_memory_vectors;
ALTER TABLE ctx_memory_vectors DROP COLUMN IF EXISTS embedding;
ALTER TABLE ctx_memory_vectors ADD COLUMN embedding VECTOR(1536) NOT NULL;
